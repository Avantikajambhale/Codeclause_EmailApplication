...
Label_0=Label(root, text="Compose a Email", width=20, fg="green", font=("bold",20))
...
compose=Label(root, text="Compose Mail", width=20, font=("bold",15))
compose.place(x=180,y=210)

Label_3=Label(root, text="Send email to:", width=20, font=("bold",10))
...
def sendemail():
    ...
    try:
        ...
        Label_6=Label(root, text="Error Occured..!", width=20,fg='red', font=("bold",15))
        Label_6.place(x=140,y=550)

        server.quit()
    except:
        Label_6=Label(root, text="Email sent Successfully......!", width=20,fg='green', font=("bold",15))
        Label_6.place(x=140,y=550)


Button(root,text="Add Attachment", width=20, bg='brown',fg="white", command=sendemail).place(x=100, y=590)
Button(root,text="Send", width=10, bg='brown',fg="white", command=sendemail).place(x=300, y=590)
Button(root,text="Cancel", width=10, bg='brown',fg="white", command=sendemail).place(x=400, y=590)
root.mainloop()
